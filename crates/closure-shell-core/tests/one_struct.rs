...
/// took it to 108. Every cluster after it lowers this line, and
/// nothing is allowed to raise it — a field that has nowhere to live
/// but here is a cluster nobody has named yet.
const CEILING: usize = 108;
