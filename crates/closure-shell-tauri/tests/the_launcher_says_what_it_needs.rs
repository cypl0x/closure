...
//! default build is webview-free on purpose (I10 — the hermetic build must
//! not need system webkitgtk), so the binary the workspace produces is
...
const BIN: &str = env!("CARGO_BIN_EXE_closure-shell-tauri");
